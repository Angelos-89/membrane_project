...
void CalculateTotal(const RectMesh& field, double& tot_energy,
...
void ChangeLattice(const RectMesh& hfield,const double& min_change,
		   const double& max_change,int& move_counter,
		   double& alpha,double& prj_area,double& tot_area,
		   const int& DoF,double& tot_energy,double& tau_energy,
